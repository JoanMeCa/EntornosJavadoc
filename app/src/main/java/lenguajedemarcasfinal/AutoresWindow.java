...
/**
 * Ventana principal para mostrar y gestionar la información de los autores.
 * Muestra la tabla de autores en la BBDD y permite realizar operaciones como añadir o eliminar animes.
 * @author Party
 */
public class AutoresWindow extends Application {
    ...
    /**
     * Al crear o eliminar un Autor se llama a esta función que limpia la tabla y la vuelve a imprimir con los
